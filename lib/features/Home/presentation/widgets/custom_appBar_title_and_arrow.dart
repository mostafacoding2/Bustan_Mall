...
class CustomAppBarTitleArrow extends StatelessWidget {
  const CustomAppBarTitleArrow({super.key, required this.title, this.onpressed,this.onpressed1,this.isShowed=false,this.arrow_back=false,  this.icondata});
  final String title;
    ...
    return    Container(
      ...
      child: Row(children: [
        ...
        Padding(
          ...
          child: Text(title,style: lightTheme.textTheme.displayLarge!.apply(
            fontSizeFactor: 1.sp,
